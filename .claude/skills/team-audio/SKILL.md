---
name: team-audio
description: "Orchestrate audio team: creative-director + sound-designer + technical-artist + gameplay-programmer for full audio pipeline from direction to implementation."
...
- `subagent_type: creative-director` — Sonic identity, emotional tone, audio palette
...
### Step 1: Audio Direction (creative-director)
Spawn the `creative-director` agent to:
