...
- **Engine recommendation** (Godot) with reasoning based on concept needs,
  team expertise, and platform targets
...
6. **Suggest next steps** (in this order — this is the professional studio
   ...
   - "Configure CLAUDE.md technology stack for Godot"
   ...
   - "Author per-system GDDs with `/design-review`"
