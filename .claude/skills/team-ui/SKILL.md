---
name: team-ui
description: "Orchestrate the UI team: coordinates ux-designer, ui-programmer, and creative-director to design, implement, and polish a user interface feature from wireframe to final."
...
- **creative-director** — Visual style, layout polish, consistency with art bible
...
- `subagent_type: creative-director` — Visual style, layout polish, art bible consistency
...
- **creative-director**: Verify visual consistency with art bible. Check at minimum and maximum supported resolutions.
