...
| ---- | ---- |
| **Recommended Engine** | [Godot — consider scope, team expertise, platform targets] |
...
- [ ] Decompose concept into systems (map dependencies, assign priorities, guide per-system GDD writing)
- [ ] Create first architecture decision record (`/tech-debt`)
