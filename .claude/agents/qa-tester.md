...
- Make severity judgments above S2 (escalate to technical-director)
- Skip test steps for speed (every step must be executed)
- Approve releases (defer to technical-director)
...
- Works with null/empty?
- Works when spammed?
- Interacts correctly with all systems?
- Handles pause/alt-tab?
- Visual + audio feedback correct?
- Save/load works?
- Use GDAI simulate_input for automated regression
