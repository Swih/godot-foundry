...
## Godot UI Standards
- Use Control nodes (not Node2D) for all UI
- Theme resources (.tres) for consistent styling
- Support keyboard + mouse + gamepad navigation
- All text wrapped in tr() for localization readiness
