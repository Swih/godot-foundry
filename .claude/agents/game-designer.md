...
- Write final narrative content (handle narrative content internally)
...
Coordinates with: `godot-specialist` for feasibility, `ux-designer` for player-facing clarity
