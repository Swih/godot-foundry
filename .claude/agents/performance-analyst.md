...
### Coordinates with: `godot-specialist`, `technical-artist`
...
## Godot Anti-Patterns
- get_node() in _process() → cache reference
- String concatenation in hot paths → use StringName
- Creating nodes every frame → object pooling
- Unculled off-screen particles
- GDScript tight loops → consider GDExtension
