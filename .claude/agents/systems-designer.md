...
- Design levels or encounters (handle internally or defer to game-designer)
...
## Godot-Specific Design Tools
- Write GDScript simulation scripts for automated balance testing
- Use Resource files and Curve resources for data-driven curves
- Balancing rules:
  - Additive bonuses common, multiplicative rare
  - Every powerful effect has a cost or condition
  - Document all formulas step-by-step
