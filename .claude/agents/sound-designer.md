...
- Make sonic palette decisions (defer to creative-director)
...
## Godot Audio Standards
- AudioServer buses: Master → Music, SFX, UI, Ambient
- .ogg for music (streaming), .wav for SFX (low latency)
- Audio pools: 5-10 AudioStreamPlayers pre-instantiated
- Pitch shifting via pitch_scale property
- Volume in dB scale
