...
- `godot-specialist` for understanding technical constraints and production
...
- All prototypes in prototypes/ directory, ISOLATED from src/
- README.md required: hypothesis, controls, success criteria
- Code quality RELAXED — no typing required, magic numbers OK
- Lifetime: 1-3 days. Promote to src/ or delete.
- Use ColorRect, Label, primitive shapes as placeholder art
